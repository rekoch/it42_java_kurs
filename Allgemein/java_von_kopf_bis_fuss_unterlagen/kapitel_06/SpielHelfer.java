...
class SpielHelfer {
 ...
 public ArrayList<String> platziereDotCom(int dotComGröße) {                 // Zeile 19
    ArrayList<String> alphaZellen = new ArrayList<String>();
    String [] alphaKoordinaten = new String [dotComGröße];      // enthält Koordinaten der Form 'f6'
    String temp = null;                                // temporärer String für concat
    int [] koordinaten = new int[dotComGröße];                  // aktuelle Koordinatenkanidaten
    int versuche = 0;                                  // aktuelle Versuchszähler
	...
	int x = 0;                                        // n-te Position in zu platzierendem DotCom
        ...
        while (erfolg && x < dotComGröße) {                // nach angrenzenden freien Stelle suchen
