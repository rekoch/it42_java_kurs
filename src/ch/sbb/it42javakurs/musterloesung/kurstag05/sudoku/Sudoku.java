...
public class Sudoku {
    ...
    public void setzeWert(int x, int y, Integer wert) {
        ...
        if (f.isInitialGesetzt()) {
            System.out.println("Das ch.sbb.it42javakurs.musterloesung.kurstag05.sudoku.Feld (" + x + "," + y + ") enthaelt einen Startwert und darf deshalb nicht mehr gesetzt werden!");
        } else {
            f.setWert(wert);
        }
    }
