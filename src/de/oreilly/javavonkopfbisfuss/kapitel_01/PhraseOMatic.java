package de.oreilly.javavonkopfbisfuss.kapitel_01;
...
public class PhraseOMatic {
    public static void main(String[] args) {
        ...
        String[] wortListeDrei = {"Schicht", "Endstufe", "Lösung", "Architektur", "Kernkompetenz", "Strategie", "Kooperation", "Kundenorientierung", "Räumlichkeit", "Vision", "Dimension", "Mission"};
